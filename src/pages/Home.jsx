...
function Home() {
  ...
  <div className="about-text">
    ...
    <p>
      Look no further, you’ve found the best brunch restaurant in RTP! Happy's Diner is serving up breakfast favorites and sandwiches in our cozy, family-friendly diner environment.
    </p>
    <p>
